  ...
  return (
    <>
      <Container fluid className={`main_container_two`}>
        ...
        <div className={`inner_main_div_wrapper ${styles.row_wrapper}`}>
          <div className={styles.main_wrapper}>
            <Row>
              <Col xl={12} xs={12}>
                <div className={`${styles.profile_heading_wrapper}`}>
                  <h5>
                    <span>S</span>
                    <span className={styles.border_pink}>ettings</span>
                  </h5>
                </div>
              </Col>
            </Row>
            <Row className={styles.form_row}>
              ...
              <Col xl={6} lg={6} sm={12}>
                <div className={styles.first_col_wrapper}>
                  ...
                  <div
                    className={`${styles.fields_wrapper} ${styles.fields_wrapper_two}`}
                  >
                    <Form.Group controlId="formBasicEmail">
                      <Form.Label className={styles.field_label_wrapper}>
            ...
            <Row className={styles.form_row}>
              <Col xl={6} lg={6} sm={12}>
                <div className={styles.second_col_wrapper}>
                  <div
                    className={`${styles.fields_wrapper} email_field_wrapper`}
                  >
                    <Form.Group controlId="formBasicEmail">
                      <Form.Label className={styles.field_label_wrapper}>
                  ...
                  <div
                    className={`${styles.fields_wrapper} email_field_wrapper pt-2`}
                  >
                    <Form.Group controlId="formBasicEmail">
                      <Form.Label className={styles.field_label_wrapper}>
                        <h6>Change Recovery Email</h6>
                      </Form.Label>
                      <Form.Control
                        type="email"
                        name="recoveryEmail"
                  ...
                  <div
                    className={`${styles.fields_wrapper} ${styles.fields_wrapper_two} country_wrapper`}
                  >
                    <Form.Group controlId="formBasicEmail">
                      <Form.Label className={styles.field_label_wrapper}>
                        <h6>Change Country of Residence</h6>
                      </Form.Label>
                      <Form.Select
                  ...
                  >
                    <Form.Group controlId="formBasicEmail">
                      ...
                      <Form.Control
                        ...
                        className={`${styles.prfile_setup_field} field mt-4`}
                      />
                      <Form.Control
                        type="password"
            ...
            <Row className={styles.form_row}>
              <Col xl={6} lg={6} sm={12}>
                <div
                  className={`${styles.second_col_wrapper} ${styles.age_wrapper}`}
                >
                  <div className={`${styles.fields_wrapper_gender}`}>
                    <Form.Label className={styles.field_label_wrapper}>
